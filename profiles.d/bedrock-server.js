...
exports.profile = {
  ...
  handler: function (profile_dir, callback) {
    ...
    try {  // BEGIN PARSING LOGIC
      ...
      item['id'] = 'bedrock-server-1.19.83.01';
      item['type'] = 'release';
      item['group'] = 'bedrock-server';
      item['webui_desc'] = '1.19.83.01 Linux x64 release';
      item['weight'] = 0;
      item['filename'] = 'bedrock-server-1.19.83.01.zip';
      item['downloaded'] = fs.existsSync(path.join(profile_dir, item.id, item.filename));
      item['version'] = 0;
      item['release_version'] = '1.19.83.01';
      item['url'] = 'https://minecraft.azureedge.net/bin-linux/bedrock-server-1.18.83.01.zip';
